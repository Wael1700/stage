...
<header class="header">
    ...
    <div class="content">
        ...
        <div class="form-container">
            <form action="{{ route('create_produit') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label for="name_produit">Product Name:</label>
                    <input type="text" id="name_produit" name="name_produit" required class="form-control">
                </div>
 ...
 <h1 style="text-align: center; margin-bottom: 20px; color: #5a4335;">My Product</h1>
        <!-- Product Display -->
        <div class="product-grid">
    @foreach($produits as $produit)
        <div class="product-item">
            <div style="width: 100%; height: 200px; border: 1px solid #ccc; display: flex; align-items: center; justify-content: center; overflow: hidden;">
            ...
            <p>Contact: <strong style="color:green;">{{ $produit->user->phone }}</strong></p>
